...
public class GuiChatNotice extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRenderer, I18n.format("citytools.chatnotice.title"), this.width / 2, 8,
				16777215);
		this.drawCenteredString(this.fontRenderer, I18n.format("citytools.chatnotice.subtitle"), this.width / 2, 18,
				16777215);
	...
	public class GuiChatNoticeList extends GuiListExtended {
		...
		public class ChatNoticeEntry implements GuiListExtended.IGuiListEntry {
			...
			private ChatNoticeEntry(String key, String sound, String patch) {
				...
				this.sound = new GuiTextField(0, mc.fontRenderer, 0, 0, 100, 20);
				...
				this.pitch = new GuiTextField(0, mc.fontRenderer, 0, 0, 100, 20);
			...
			public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY,
				...
				mc.fontRenderer.drawStringWithShadow(I18n.format("citytools.chatnotice.text"), 
						x, y, 0xffffff);
				text.x = x;
				text.y = y + 10;
				text.width = 175;
				text.height = 16;
				text.drawTextBox();
				mc.fontRenderer.drawStringWithShadow(I18n.format("citytools.chatnotice.sound"), 
						x, y + 28, 0xffffff);
				sound.x = x;
				sound.y = y + 38;
				sound.width = 150;
				sound.height = 16;
				sound.drawTextBox();
				mc.fontRenderer.drawStringWithShadow(I18n.format("citytools.chatnotice.patch"),
						x + 155, y + 28, 0xffffff);
				pitch.x = x + 155;
				pitch.y = y + 38;
				pitch.width = 20;
				...
				this.btnRemove.y = y + 10;
				this.btnRemove.displayString = "§c§l" + I18n.format("citytools.chatnotice.remove");
				this.btnRemove.drawButton(GuiChatNotice.GuiChatNoticeList.this.mc, mouseX, mouseY, partialTicks);
				this.btnPlay.x = x + 185;
				this.btnPlay.y = y + 34;
				this.btnPlay.displayString = I18n.format("citytools.chatnotice.play");
				this.btnPlay.drawButton(GuiChatNotice.GuiChatNoticeList.this.mc, mouseX, mouseY, partialTicks);
			...
			public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_,
				...
				if (this.btnPlay.mousePressed(GuiChatNoticeList.this.mc, p_148278_2_, p_148278_3_)) {
					...
					GuiChatNoticeList.this.mc.getSoundHandler()
						.playSound(PositionedSoundRecord.getMasterRecord(
								new SoundEvent(new ResourceLocation(this.sound.getText())), Util.strToFloat(this.pitch.getText(),1.0F)));
					return true;
				} else {
					return false;
				}
