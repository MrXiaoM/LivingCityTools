...
public class GuiTpToPlayer extends GuiScreen {
	...
	protected void actionPerformed(GuiButton button) {
		if (button.id == 0) {
			...
			// ✔
			mc.ingameGUI.setRecordPlayingMessage(I18n.format("citytools.menu.teleport.player.showtitle"));
		}
		if (button.id == 1) {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRenderer, str2, this.width / 2 - 100, this.height / 2 - 36 - fontRenderer.FONT_HEIGHT,
				-1);
	...
	public void initGui() {
		...
		tfName = new GuiTextField(0, fontRenderer, (width / 2) - 100, (height / 2) - 30, 200, 20);
