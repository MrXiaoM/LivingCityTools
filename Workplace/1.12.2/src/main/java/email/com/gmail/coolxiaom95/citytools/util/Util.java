...
public class Util {
	...
	public static void addMessage(String message) {
		if (Minecraft.getMinecraft() != null) {
			...
			if (mc.player != null) {
				mc.player.sendStatusMessage(new TextComponentString(message),false);
			}
		}
	}
	...
	public static ArrayList<String> getScoreboard() {
		if (Minecraft.getMinecraft() != null) {
			...
			if (mc.world != null) {
				...
				if (scoreboard != null && mc.player != null) {
					ScorePlayerTeam scoreplayerteam = scoreboard
							.getPlayersTeam(Minecraft.getMinecraft().player.getName());
					...
					int i = mc.fontRenderer.getStringWidth(scoreobjective1.getDisplayName());

					for (Score score : collection) {
						ScorePlayerTeam scoreplayerteam1 = scoreboard.getPlayersTeam(score.getPlayerName());
						String s = ScorePlayerTeam.formatPlayerName(scoreplayerteam1, score.getPlayerName()) + ": §c"
								 + score.getScorePoints();
						i = Math.max(i, mc.fontRenderer.getStringWidth(s));
					}
