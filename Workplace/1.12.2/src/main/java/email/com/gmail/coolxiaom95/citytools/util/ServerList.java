...
public class ServerList {
	...
	public void loadServerList() {
		this.servers.clear();
		this.servers.add(new ServerData("§b§l自动线路 §7(较卡)", "mc.66ko.cc", false));
		this.servers.add(new ServerData("§a§l电信线路", "dx.66ko.cc", false));
		this.servers.add(new ServerData("§a§l联通线路", "lt.66ko.cc", false));
		this.servers.add(new ServerData("§a§l移动线路", "yd.66ko.cc", false));
		this.servers.add(new ServerData("§c§l备用线路", "218.93.206.50", false));
	}
