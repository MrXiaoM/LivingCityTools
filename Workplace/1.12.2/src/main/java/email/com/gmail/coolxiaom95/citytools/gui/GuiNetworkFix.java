...
public class GuiNetworkFix extends GuiScreen{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		mc.fontRenderer.drawStringWithShadow(I18n.format("citytools.networkfix.title"), width /2 - mc.fontRenderer.getStringWidth(I18n.format("citytools.networkfix.title"))/2, 20, -1);
		for(int i = 0; i<=5;i++) {
			mc.fontRenderer.drawStringWithShadow(I18n.format("citytools.networkfix.context."+i), width /2 - 80, 50 + (mc.fontRenderer.FONT_HEIGHT+2)*i, -1);
		}
