...
public class GuiPayRecord extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(mc.fontRenderer, I18n.format("citytools.payrecord.title"), this.width / 2, 16, 0xffffff);
		this.drawCenteredString(mc.fontRenderer, I18n.format("citytools.payrecord.subtitle"), this.width / 2, 28, 0x515658);
