...
public class PayRecordList extends GuiListExtended {
	...
	public class PayRecordListEntry implements GuiListExtended.IGuiListEntry {
		...
		public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY,
				boolean isSelected) {
			mc.fontRendererObj.drawString(this.method, x, y + 2, -1);
			mc.fontRendererObj.drawString(this.date, x + 30, y + 2, -1);
			mc.fontRendererObj.drawString(this.player, x + 110, y + 2, -1);
			mc.fontRendererObj.drawString(this.money, x + 200, y + 2, -1);
			Util.drawRect(x, y + mc.fontRendererObj.FONT_HEIGHT + 4, x + 240, y + mc.fontRendererObj.FONT_HEIGHT + 6, 255, 66, 66, 66);
		}
