...
public class GuiUser extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		String str2 = I18n.format("citytools.menu.info.2", mc.thePlayer.experienceLevel);
		String str3 = I18n.format("citytools.menu.info.3", mc.thePlayer.getHealth(), mc.thePlayer.getMaxHealth());

		String str4 = I18n.format("citytools.menu.info.4", "§7" + I18n.format("citytools.menu.info.4.none"));
		if (mc.thePlayer.inventory.getCurrentItem() != null) {
			str4 = I18n.format("citytools.menu.info.4", mc.thePlayer.inventory.getCurrentItem().getDisplayName());
		}
		...
		if (mc.thePlayer.inventory.armorItemInSlot(2) != null) {
			str5 = I18n.format("citytools.menu.info.5", mc.thePlayer.inventory.armorItemInSlot(2).getDisplayName());
		}

		this.drawString(fontRendererObj, str1, this.width / 2 - 124 + 56, this.height / 2 - 83 + 18, -1);
		this.drawString(fontRendererObj, str2, this.width / 2 - 124 + 56,
				this.height / 2 - 83 + 18 + fontRendererObj.FONT_HEIGHT * 1, -1);
		this.drawString(fontRendererObj, str3, this.width / 2 - 124 + 56,
				this.height / 2 - 83 + 18 + fontRendererObj.FONT_HEIGHT * 2, -1);

		this.drawString(fontRendererObj, str4 + "§r", this.width / 2 + 20, this.height / 2 - 83 + 18, -1);
		this.drawString(fontRendererObj, str5 + "§r", this.width / 2 + 20,
				this.height / 2 - 83 + 18 + fontRendererObj.FONT_HEIGHT * 1, -1);

		this.drawString(fontRendererObj, mc.thePlayer.getUniqueID().toString(), this.width / 2 - 118,
				this.height / 2 + 79 - fontRendererObj.FONT_HEIGHT, -1);
