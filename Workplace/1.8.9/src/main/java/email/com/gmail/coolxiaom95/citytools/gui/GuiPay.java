...
public class GuiPay extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRendererObj, str2, this.width / 2 - 100, this.height / 2 - 40 - fontRendererObj.FONT_HEIGHT,
				-1);
	...
	public void initGui() {
		...
		tfPay = new GuiTextField(0, fontRendererObj, (width / 2) - 100, (height / 2), 200, 20);
