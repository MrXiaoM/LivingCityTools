...
public class GuiEmail extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(mc.fontRendererObj, str1, this.width / 2 - 110, this.height / 2 - 83 + 10, -1);

		tfName.drawTextBox();
		String str2 = I18n.format("citytools.menu.mail.name", mc.getSession().getPlayerID());
		this.drawString(fontRendererObj, str2, this.width / 2 - 100, this.height / 2 - 40 - fontRendererObj.FONT_HEIGHT, -1);

		tfContext.drawTextBox();
		String str3 = I18n.format("citytools.menu.mail.context", mc.getSession().getPlayerID());
		this.drawString(fontRendererObj, str3, this.width / 2 - 100, this.height / 2 - fontRendererObj.FONT_HEIGHT, -1);
	...
	public void initGui() {
		...
		tfName = new GuiTextField(0, fontRendererObj, (width / 2) - 100, (height / 2) - 40, 200, 20);
		tfName.setMaxStringLength(64);
		tfName.setFocused(false);
		tfName.setCanLoseFocus(true);

		tfContext = new GuiTextField(0, fontRendererObj, (width / 2) - 100, (height / 2), 200, 20);
