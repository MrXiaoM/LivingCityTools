...
public class GuiIgnore extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, I18n.format("citytools.ignore.title"), this.width / 2, 10, -1);
		this.drawCenteredString(this.fontRendererObj, "§7" + I18n.format("citytools.ignore.subtitle"), this.width / 2,
				20, -1);
	...
	public void updateScreen() {
		btnCancel.xPosition = width / 2 + 55;
		btnCancel.yPosition = height - 32;

		btnSave.xPosition = width / 2 - 155;
		btnSave.yPosition = height - 32;

		btnAdd.xPosition = width / 2 - 50;
		btnAdd.yPosition = height - 32;

		btnLoad.xPosition = width - 158;
		btnLoad.yPosition = 8;
	}
}
